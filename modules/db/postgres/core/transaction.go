...
func (t *Transaction) String() string {
	return commonresource.Display("db.postgres.transaction")
}

func (t *Transaction) Hash() uint64 {
	return commonresource.Hash("db.postgres.transaction", t.id)
}
...
func (t *Transaction) MarshalJSON() ([]byte, error) {
	return commonresource.MarshalDisplayJSON("db.postgres.transaction")
}
