...
func (es *TestEventStream) RecvMsg(i any) error {
	// NOT IMPLEMENTED
	return nil
}

func (es *TestEventStream) Recv() (any, error) {
	msg := <-es.messages
...
func TestLoop(t *testing.T) {
	Convey(".AddListener", t, func() {
		Convey("Should add a new listener", func() {
			...
			loop.AddListener(TestEvent, events.Always(func(ctx context.Context, message any) {
				counter.Increase()
			}))
	...
	Convey(".RemoveListener", t, func() {
		Convey("Should remove a listener", func() {
			Convey("Should add a new listener", func() {
				...
				id := loop.AddListener(TestEvent, events.Always(func(ctx context.Context, message any) {
					counter.Increase()
				}))
