...
type (
	...
	Handler func(ctx context.Context, message any) bool
...
func Always(fn func(ctx context.Context, message any)) Handler {
	return func(ctx context.Context, message any) bool {
		fn(ctx, message)
...
func Once(fn func(ctx context.Context, message any)) Handler {
	return func(ctx context.Context, message any) bool {
		fn(ctx, message)
