...
func xmlDocumentValue(root runtime.Value) *runtime.Object {
...
func xmlElementValue(name string, attrs map[string]runtime.Value, children ...runtime.Value) *runtime.Object {
...
func xmlTextValue(value string) *runtime.Object {
	return runtime.NewObjectWith(map[string]runtime.Value{
