...
func (el *HTMLElement) Click(ctx context.Context, count runtime.Int) error {
	return withElementError(ctx, el, func() error { return el.input.Click(ctx, el.id, int(count)) })
}

func (el *HTMLElement) ClickBySelector(ctx context.Context, selector drivers.QuerySelector, count runtime.Int) error {
	return withElementError(ctx, el, func() error { return el.input.ClickBySelector(ctx, el.id, selector, count) })
}
...
func (el *HTMLElement) Input(ctx context.Context, value runtime.Value, delay runtime.Int) error {
	...
	return withElementError(ctx, el, func() error {
...
func (el *HTMLElement) Press(ctx context.Context, keys []runtime.String, count runtime.Int) error {
	return withElementError(ctx, el, func() error { return el.input.Press(ctx, sdk.UnwrapStrings(keys), int(count)) })
}
...
func (el *HTMLElement) Clear(ctx context.Context) error {
	return withElementError(ctx, el, func() error { return el.input.Clear(ctx, el.id) })
}

func (el *HTMLElement) ClearBySelector(ctx context.Context, selector drivers.QuerySelector) error {
	return withElementError(ctx, el, func() error { return el.input.ClearBySelector(ctx, el.id, selector) })
}

func (el *HTMLElement) Select(ctx context.Context, value runtime.List) (runtime.List, error) {
	return withElementResult(ctx, el, func() (runtime.List, error) { return el.input.Select(ctx, el.id, value) })
}
...
func (el *HTMLElement) SelectBySelector(ctx context.Context, selector drivers.QuerySelector, value runtime.List) (runtime.List, error) {
	return withElementResult(ctx, el, func() (runtime.List, error) {
...
func (el *HTMLElement) ScrollIntoView(ctx context.Context, options drivers.ScrollOptions) error {
	return withElementError(ctx, el, func() error { return el.input.ScrollIntoView(ctx, el.id, options) })
}

func (el *HTMLElement) Focus(ctx context.Context) error {
	return withElementError(ctx, el, func() error { return el.input.Focus(ctx, el.id) })
}

func (el *HTMLElement) FocusBySelector(ctx context.Context, selector drivers.QuerySelector) error {
	return withElementError(ctx, el, func() error { return el.input.FocusBySelector(ctx, el.id, selector) })
}

func (el *HTMLElement) Blur(ctx context.Context) error {
	return withElementError(ctx, el, func() error { return el.input.Blur(ctx, el.id) })
}

func (el *HTMLElement) BlurBySelector(ctx context.Context, selector drivers.QuerySelector) error {
	return withElementError(ctx, el, func() error { return el.input.BlurBySelector(ctx, el.id, selector) })
}

func (el *HTMLElement) Hover(ctx context.Context) error {
	return withElementError(ctx, el, func() error { return el.input.MoveMouse(ctx, el.id) })
}

func (el *HTMLElement) HoverBySelector(ctx context.Context, selector drivers.QuerySelector) error {
	return withElementError(ctx, el, func() error { return el.input.MoveMouseBySelector(ctx, el.id, selector) })
}

func (el *HTMLElement) Unhover(ctx context.Context) error {
	return withElementError(ctx, el, func() error { return el.input.Unhover(ctx, el.id) })
}

func (el *HTMLElement) UnhoverBySelector(ctx context.Context, selector drivers.QuerySelector) error {
	return withElementError(ctx, el, func() error { return el.input.UnhoverBySelector(ctx, el.id, selector) })
}
